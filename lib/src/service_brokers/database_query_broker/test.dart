...
//       final stream1 = _getBaseQuery(
//         collection,
//         limit: limit,
//         ascendByField: ModelUserPub.K_DISPLAY_NAME,
//       )
...
//       collection,
//       limit: pidSet?.length,
//       ascendByField: ModelUserPub.K_CREATED_AT,
//     ).where(ModelUserPub.K_ID, whereIn: pidSet).snapshots();
...
//     final collection = this.firebaseFirestore.collection(collectionPath);
//     final pidSet = pids.nullIfEmpty?.toSet();
//     final relationships = _getBaseQuery(
//       collection,
//       limit: limit,
//       ascendByField: ModelRelationship.K_CREATED_AT,
//     )
...
//   @visibleForTesting
//   @override
//   Future<Iterable<DeleteOperation>> getLazyDeleteCollectionOperations({
//     required DataRef collectionRef,
//   }) async {
//     final collectionPath = collectionRef.collectionPath!;
//     final collection = this.firebaseFirestore.collection(collectionPath);
//     final stream = _getBaseQuery(collection)
//         .snapshots()
//         .map((e) => e.docs.map((doc) => DeleteOperation(ref: collectionRef.copyWith(id: doc.id))));
//     final results =
//         (await stream.toList().then((value) => value.tryReduce((a, b) => [...a, ...b]))) ?? [];
//     return results;
//   }
...
//       collection,
//       limit: pidSet?.length,
//       ascendByField: ModelUser.K_CREATED_AT,
//     )
//         .where(
//           ModelJob.K_PID,
//           whereIn: pidSet,
...
//       collection,
//       limit: pidSet?.length,
//       ascendByField: ModelOrganization.K_CREATED_AT,
//     )
//         .where(
...
//       collection,
//       limit: pidSet?.length,
//       ascendByField: ModelProject.K_CREATED_AT,
//     )
//         .where(
//           ModelProject.K_PID,
//           whereIn: pidSet,
...
//       collection,
//       limit: pidSet?.length,
//       ascendByField: ModelJob.K_CREATED_AT,
//     )
//         .where(
//           ModelJob.K_PID,
//           whereIn: pidSet,
...
//       collection,
//       limit: limit,
//       ascendByField: ModelFileEntry.K_CREATED_AT,
//     )
//         .where(
